...
From this we can identify food high in protiens, fats, carbs. 
...
2.  Non-parametric estimation is incredibly useful for prediction. not so much explanation. (which is what were attempting to do right now)
